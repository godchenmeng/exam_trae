...
namespace ExamSystem.Infrastructure.Migrations
{
    ...
    [Migration("20251019171711_AddNotifications")]
            ...
            modelBuilder.Entity("ExamSystem.Domain.Entities.QuestionBank", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            BankId = 1,
                            CreatedAt = new DateTime(2025, 10, 20, 1, 17, 10, 726, DateTimeKind.Local).AddTicks(5189),
                            CreatorId = 1,
                            Description = "系统默认题库",
                            IsActive = true,
                            Name = "默认题库",
                            UpdatedAt = new DateTime(2025, 10, 20, 1, 17, 10, 726, DateTimeKind.Local).AddTicks(5259)
                        });
                });
            ...
            modelBuilder.Entity("ExamSystem.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            CreatedAt = new DateTime(2025, 10, 20, 1, 17, 10, 725, DateTimeKind.Local).AddTicks(9707),
